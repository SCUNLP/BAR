...
class SteveIText(MarkBase):
    ...
    def __init__(self, env, cond_scale: float = 6.0,  device: Union[str, torch.device] = "cuda", **unused_kwargs):
        ...
        mineclip_config['ckpt']['path'] = "/home/duweihong/PycharmProjects/2024/SimulatorProjects/minecraft_env/CurrentWork/MineDreamer/data/weights/mineclip/attn.pth"
        self.mineclip = load_mineclip.load(mineclip_config, device=self.device)
        print('mineclip loaded')

        prior_info = PRIOR_INFO
        prior_info['model_path'] = "/home/duweihong/PycharmProjects/2024/SimulatorProjects/minecraft_env/CurrentWork/MineDreamer/data/weights/steve1/steve1_prior.pt"
        self.prior = load_vae_model(prior_info, device=self.device)
        print('prior loaded')
        VPT_MODEL_PATH = "/home/duweihong/PycharmProjects/2024/SimulatorProjects/minecraft_env/CurrentWork/MineDreamer/data/weights/vpt/2x.model"
        VPT_WEIGHT_PATH = "/home/duweihong/PycharmProjects/2024/SimulatorProjects/minecraft_env/CurrentWork/MineDreamer/data/weights/steve1/steve1.weights"
    ...
    def do(
        ...
        **kwargs, 
        ...
        while (
            ...
            if self.info['isGuiOpen']:  # 保证背包不打开
