...
MY_TAG_ITEMS_FILE = FILE_DIR / "my_tag_items.json"
SKILL_FILE = FILE_DIR / "skill.json"
MEMORY_FILE = FILE_DIR / "memory.json"
TASKS_FILE = FILE_DIR / "tasks.json"

# MODIFIED
MY_SKILL_FILE = FILE_DIR / "my_skill.json"

MINE_TAG_ITEMS_FILE = FILE_DIR / "different_tag_items" / "mine_tag_items.json"
SMELT_TAG_ITEMS_FILE = FILE_DIR / "different_tag_items" / "smelt_tag_items.json"
